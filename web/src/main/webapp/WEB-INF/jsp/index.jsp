...
<div id="myNiceCarousel" class="carousel slide" data-ride="carousel" style="margin-top: 76px">
  <!-- 圆点指示器 -->
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img alt="First slide" class="center-block" src="<s:url value='/image/slider1.png' />">
    ...
    <!--<div class="item">
        <img alt="Second slide" src="image/slider1.png">
        <div class="carousel-caption">
            <h3></h3>
            <p></p>
        </div>
    ...
    <div class="item">
        <img alt="Third slide" src="image/slider1.png">
        <div class="carousel-caption">
            <h3></h3>
            <p></p>
        </div>
...
<div class="main-container">
  ...
  <div class="row main-function">
    <div class="col-md-4">
      <div class="pull-left function-head">
