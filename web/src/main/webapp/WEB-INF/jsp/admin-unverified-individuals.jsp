...
<head>
  ...
  <title>个人身份认证 - 存证通可信数据保全服务平台</title>
  <!-- Bootstrap -->
  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="<s:url value='/admin/unverified-individuals' />">个人身份认证</a></li>
              ...
              <tbody>
                <c:forEach var="user" items="${users}">
                  <tr>
                    ...
                    <td>${user.value.idCardNumber}</td>
                    <td>
                      <a class="btn btn-info btn-xs" href="#" role="button">详情</a>
                      <a class="btn btn-success btn-xs" href="<s:url value='/admin/verify-user?type=individual&userId=${user.value.id}' />" role="button">通过认证</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<s:url value='/admin/verify-user?type=individual' />" method="post">
