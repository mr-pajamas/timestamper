...
<head>
    ...
    <title>身份信息审核中 - 存证通可信数据保全服务平台</title>
</head>
<body>
...
<div style="width: 500px;" class="center-block with-padding">
    ...
    <h1 class="clearfix text-info"><i class="fa fa-clock-o fa-3x pull-left" aria-hidden="true"></i>身份信息审核中<br><small>提交审核后，预计2个工作日内完成审核<br>请耐心等待</small></h1>
    <br>
