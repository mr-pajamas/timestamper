...
<head>
    ...
    <title>企业信息审核通过 - 存证通可信数据保全服务平台</title>
</head>
<body>
...
<div style="width: 500px;" class="center-block with-padding">
    ...
    <h1 class="text-success clearfix"><i class="fa fa-check-circle-o fa-3x pull-left" aria-hidden="true"></i>企业信息审核通过！<br><small>恭喜！现在贵方可以使用存证服务了</small></h1>
    <br>
